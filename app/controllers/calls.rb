get '/incoming-call' do
  ...
  Twilio::TwiML::Response.new do |r|
    ...
    r.Gather :numDigits => '1', :action => '/hello-monkey/handle-gather', :method => 'get' do |g|
      ...
      g.Say 'Push one, two, or three. Pressing one will read you a little message.'
      g.Say 'Two will let you record yourself so you can listen to yourself talk. Three will let you record a voicemail that I will receive.'
...
get '/incoming-call/handle-gather' do
  redirect '/incoming-call' unless ['1', '2', '3'].include?(params['Digits'])
  if params['Digits'] == '1'
    ...
    response = Twilio::TwiML::Response.new do |r|
      ...
      r.Record :maxLength => '30', :action => '/incoming-call/handle-record', :method => 'get'
    end
...
get '/incoming-call/handle-record' do
  Twilio::TwiML::Response.new do |r|
